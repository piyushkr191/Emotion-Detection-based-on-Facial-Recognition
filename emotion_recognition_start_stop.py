...
# ## Load model
# model = load_model("./emotion_recognition/Models/trained_models/resnet50_ferplus.h5")
# model = load_model('./emotion_recognition/Models/trained_models/resnet50_ferplus.h5', compile=False)
